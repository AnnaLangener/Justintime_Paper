...
sd_outcome <- 0.2 # Controls variability BETWEEN different subject (e.g., tracking depression 0.21)
...
result <- read.csv("/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/simulation_results.csv")
...
ggsave(  "/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/Example2.jpg",
  plot = p1,
  width = 10.2,
  height = 4.5)
...
ggsave(  "/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/Example4.jpg",
  plot = combined_plot,
  width = 10.2,
  height = 5.5)
...
mean(result$auc_c_individual)
mean(result$auc_individual)

test <- result$auc_c-result$auc
...
ggsave(  "/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/Example3.jpg",
  plot = combined_plot,
  width = 11.5,
  height = 6.5)
```
...
ggsave(  "/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/Example_var.jpg",
  plot = p2,
  width = 8,
  height = 7)
...
result = read.csv("/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/simulation_results_baseline.csv")
...
ggsave(  "/Users/f007qrc/Library/CloudStorage/GoogleDrive-anna.m.langener@dartmouth.edu/My Drive/Darmouth Drive/ML CrossValidation Project/figure7.jpg",
  plot = p7,
  width = 10,
  height = 5)
